...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lbl_analyzed_stem = QtWidgets.QLabel(parent=self.frameMetadata)
        ...
        self.metadataLayout.addWidget(self.lbl_analyzed_stem)
        self.containerWaveform = QtWidgets.QWidget(parent=self.frameMetadata)
        self.containerWaveform.setMinimumSize(QtCore.QSize(0, 90))
        self.containerWaveform.setObjectName("containerWaveform")
        self.waveformContainerLayout = QtWidgets.QVBoxLayout(self.containerWaveform)
        self.waveformContainerLayout.setContentsMargins(0, 0, 0, 0)
        self.waveformContainerLayout.setObjectName("waveformContainerLayout")
        self.metadataLayout.addWidget(self.containerWaveform)
        self.containerEqCurve = QtWidgets.QWidget(parent=self.frameMetadata)
        self.containerEqCurve.setMinimumSize(QtCore.QSize(0, 100))
        self.containerEqCurve.setObjectName("containerEqCurve")
        self.eqCurveContainerLayout = QtWidgets.QVBoxLayout(self.containerEqCurve)
        self.eqCurveContainerLayout.setContentsMargins(0, 0, 0, 0)
        self.eqCurveContainerLayout.setObjectName("eqCurveContainerLayout")
        self.metadataLayout.addWidget(self.containerEqCurve)
        ...
        self.frameFilters = QtWidgets.QFrame(parent=Dialog)
        self.frameFilters.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.frameFilters.setObjectName("frameFilters")
        self.filtersLayout = QtWidgets.QVBoxLayout(self.frameFilters)
        self.filtersLayout.setContentsMargins(16, 8, 16, 8)
        self.filtersLayout.setSpacing(8)
        self.filtersLayout.setObjectName("filtersLayout")
        self.lineSepFilters = QtWidgets.QFrame(parent=self.frameFilters)
        ...
        self.filtersLayout.addWidget(self.lineSepFilters)
        self.filtersHeaderLayout = QtWidgets.QHBoxLayout()
        self.filtersHeaderLayout.setObjectName("filtersHeaderLayout")
        self.lbl_filters_title = QtWidgets.QLabel(parent=self.frameFilters)
        ...
        self.filtersHeaderLayout.addItem(spacerItem1)
        self.btn_query_filters = QtWidgets.QPushButton(parent=self.frameFilters)
        self.btn_query_filters.setObjectName("btn_query_filters")
        self.filtersHeaderLayout.addWidget(self.btn_query_filters)
        self.filtersLayout.addLayout(self.filtersHeaderLayout)
        self.list_filters = QtWidgets.QListWidget(parent=self.frameFilters)
        self.list_filters.setMinimumSize(QtCore.QSize(0, 110))
        self.list_filters.setMaximumSize(QtCore.QSize(16777215, 150))
        ...
        self.filtersLayout.addWidget(self.list_filters)
        self.filtersFooterLayout = QtWidgets.QHBoxLayout()
        self.filtersFooterLayout.setObjectName("filtersFooterLayout")
        self.lbl_filters_status = QtWidgets.QLabel(parent=self.frameFilters)
        ...
        self.filtersFooterLayout.addItem(spacerItem2)
        self.btn_apply_filters = QtWidgets.QPushButton(parent=self.frameFilters)
        ...
        self.filtersLayout.addLayout(self.filtersFooterLayout)
        self.mainLayout.addWidget(self.frameFilters)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lbl_filters_title.setText(_translate("Dialog", "🎛  Filtros do Pedal (ESP32-S3)"))
        self.btn_query_filters.setText(_translate("Dialog", "🔍  Consultar Filtros Disponíveis"))
        self.lbl_filters_status.setText(_translate("Dialog", "Nenhum filtro consultado ainda."))
        self.btn_apply_filters.setText(_translate("Dialog", "✅  Aplicar Filtros Selecionados"))
